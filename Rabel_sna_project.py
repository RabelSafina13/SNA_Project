...
Original file is located at
    https://colab.research.google.com/drive/18txS40XoH1HkHJQLGMqGtInFAZ57MP-9
...
number_of_similar_users = input('Enter ASIN of product:')
...
"""Reads file and Extracts the necessary information from it"""
...
def read_file():
    ...
    count = 0
    count1 = 0
    with open("amazon-meta32.txt") as f:
        for line in f:       
...
def n_neighbor(G, start,n):
    ...
    while len(list(next_nodes)) > 0 and n > total:
        total = total + len(list(next_nodes))               
    ...
    if n <= total:#get top n users for the given user using similarity
        ...
        print('There are only maximum of',total,'similar users to this',start)       
